...
- track books that exist in our repository / library
    - browse books by author name, title, genre 
- users' system that allow them to review & comment
- Track books location by adding an entry to whom lended it and when 

## non-functional requirements
- plataforms: progressive web app
- easy of use
- intuitive design with a minimal steps
